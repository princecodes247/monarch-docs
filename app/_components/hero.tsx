          ...
          >
            <div className="mr-auto text-[0.84rem] ml-2 text-zinc-400 text-left md:text-lg lg:max-w-2xl md:py-5">
              <pre className="tracking-tight uppercase max-w-md md:max-w-3xl text-wrap">
                Build with mongodb in a type-safe way.
              </pre>
            </div>
          </HeroAnimated>
            <div className="mr-auto ml-2  flex flex-wrap gap-y-4 items-start justify-start gap-x-3">
              <LinkItem
                href="/components"
                className="inline-flex rounded-none uppercase font-mono text-white  text-center group items-center w-full justify-center bg-transparent  border-input border-[1px] hover:bg-white/10 transition-colors sm:w-auto py-4 px-10"
              >
                Get Started
